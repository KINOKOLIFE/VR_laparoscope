...
public:
    ...
    void update(glm::mat4 &camera_position){
                    ...
                    geo_shader.begin();{
                        ...
                        ofPushMatrix();{
                            ...
                            ofFill();
                                ...
                                //----ULTRA SOUND IMAGE
                                for(auto &mc : stack_manager::stacks){
                                    geo_shader.setUniform1i("u_isLight", 0);
                                    if(mc.use_tecxture){
                                ...
                                for(auto &c : meshHolder::mesh_imported){
                                    ...
                                    if(c.parent_isDysplay && c.dysplay){
                                        ofPushMatrix();{
                                            ...
                                            c.mesh.draw();
                                            if(c.pick_target){
                                                glm::vec3 t = c.mesh.getVertex(Controller::nearlest_vertex_from_picker);
                                                ofDrawSphere(t.x, t.y, t.z, 6);
                                            }
                                        }ofPopMatrix();
                                    }
                                }
